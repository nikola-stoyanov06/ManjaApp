...
namespace ManjaApp.Web.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(ICategoryService categoryService, ApplicationDbContext context, IManjaService manjaService)
        {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var manjas = await _manjaService.GetManjasByCategoryIdAsync(category.Id);
            ViewBag.Manjas = manjas;
